...
resource "aws_iam_role" "wishbone-search-role" {
    name = "wishboone-search-role"
...
resource "aws_iam_role_policy_attachment" "search-lambda-provide-rds-access" {
  role = aws_iam_role.wishbone-search-role.name
  policy_arn = "arn:aws:iam::aws:policy/AmazonRDSFullAccess"
}

resource "aws_iam_role_policy_attachment" "search-lambda-execution-role" {
  role = aws_iam_role.wishbone-search-role.name
